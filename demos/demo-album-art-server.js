...
console.log('Simple webserver implementation making use of iTunes and Linkshare libraries.');
console.log('Point a web browser to http://localhost:8005/test to start the test.');
console.log('You will see \'invalid token specified\' unless you change the demo to use your own valid token.');
